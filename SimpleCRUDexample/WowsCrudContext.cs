...
namespace WowsCrudNamespace
{
    ...
    public class WowsCrudContext : CacheEXTREME2.WProxyGlobal.CacheEXTREMEcontext
    {
        ...
        {
            base.structsManagers.Add(new StructManager<Classification>(base.globalMeta.GetLocalStructs()[0], base.structsManagers));
            base.structsManagers.Add(new StructManager<Contact>(base.globalMeta.GetLocalStructs()[1], base.structsManagers));
    ...
    public class ManufacturerProxy
    {
        ...
        // name: Charge(ContactInfo)=> struct Id 1;
        public Contact Charge;
           
        // name: Ports(List<name: (ContactInfo)=> struct Id 1;>), min: 0, max: 1000
        public List<Contact> Ports;
     
        public ManufacturerProxy(String Country, List<Contact> Ports, Contact Charge)
        {
    ...
    public class ShipCounterProxy
    {
        ...
        // name: Classification(Classification)=> struct Id 0;
        public Classification Classification;
        
        // name: Count(Int32), min: 1, max: 100500, def: 1
        public Int32 Count;
    ...
    public class ShipInfoProxy
    {
        ...
        // name: ShipName(String), min: 0, max: 255, def: ShipName
        public String Name;
        
        // name: Captain(ContactInfo)=> struct Id 1;
        ...
        public ShipInfoProxy(String Country, Classification Classification, String ShipName, Contact Captain, Int32 StuffCount, Double Efficienty)
        {
            this.Country = Country;
            this.Classification = Classification;
            this.Name = ShipName;
    ...
    public class ShipInfoProxyKey
    {
        ...
        public ShipInfoProxyKey(String Country, Classification Classification, String ShipName)
        {
            this.Country = Country;
            this.Classification = Classification;
            this.Name = ShipName;
